...
public class GameManager : Singleton<GameManager>
{
    ...
    [SerializeField]
    private Text continueButtonLBL;
    [SerializeField]
    private Button continueButton;
    [SerializeField]
    private Text totalEscapedLBL;
    [SerializeField]
    private GameObject YouWinLBL;
    [SerializeField]
    ...
    IEnumerator spawn() {
        if (enemiesPerSpawn > 0 && EnemyList.Count < totalEnemies)
        {
            ...
            { //Creates enemies while the enemies on screen is less than max
                ...
                {
                    Enemy newEnemy = Instantiate(enemies[Random.Range(0, enemiesToSpawn)]); //Cast as a game object
    ...
    public void setCurrentGameFunction()
    {
        ...
        else if (WaveNumber >= TotalWaves - 1)
        {
    ...
    public void showMenu()
    {
        switch (CurrentState)
        {
            ...
            case GameStatus.pause:
                ...
                break;
            case GameStatus.win:
                YouWinLBL.SetActive(true);
                playButtonLBL.text = "Play Again";
                continueButton.gameObject.SetActive(true);
                AudioSource.PlayOneShot(SoundManager.Instance.Cheer);
                AudioSource.PlayOneShot(SoundManager.Instance.Firecracker);
                break;
        }
